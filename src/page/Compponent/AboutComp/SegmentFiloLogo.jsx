...
const SegmentFiloLogo = () => {
  return (
    <div className="overflow-hidden bg-[100] flex flex-col w-full mx-auto bg-clip-content bg-repeat-y lg:bg-cover bg-contain lg:max-w-[1920px] h-full lg:h-auto -mt-8 lg:-mt-24 mb-0 lg:pb-32 justify-center" style={{backgroundImage:`url(${BgFiloLogo})`}}>
        ...
        <div className='grid grid-cols-1 grid-rows-4 lg:grid-rows-2 lg:grid-cols-2 gap-x-36 gap-y-24 h-full mt-10 px-12'>
